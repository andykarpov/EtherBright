...
void enc28j60Init(u08* mac_addr)
{
	// initialize I/O
...
//	enc28j60Write(MACON3, MACON3_PADCFG0|MACON3_TXCRCEN|MACON3_FRMLNEN);
	...
	enc28j60Write(MAADR5, *mac_addr++);
	enc28j60Write(MAADR4, *mac_addr++);
	enc28j60Write(MAADR3, *mac_addr++);
	enc28j60Write(MAADR2, *mac_addr++);
	enc28j60Write(MAADR1, *mac_addr++);
	enc28j60Write(MAADR0, *mac_addr++);
